  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 h-24 transition-all duration-300 ${
        isScrolled ? "bg-white backdrop-blur-xl shadow-md" : "bg-transparent"
      }`}
    >
      <Container>
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex flex-row gap-12 items-center justify-center">
              ...
              {navlinks.map((item) => (
                <Link
                  ...
                  className={`cursor-pointer text-lg transition-colors duration-300  ${
                    isScrolled ? "text-primary hover:underline " : "text-primary"
                  }`}
                >
                  {item.name}
                </Link>
            ...
            <div>
              <Link href="/contactus">
                <button
                  className={`rounded-xl p-2 px-3 transition-all duration-300 text-lg ${
                    isScrolled
                      ? "bg-primary text-white hover:bg-secondary2 text-2xl"
                      : "border border-white text-primary hover:bg-primary/80"
                  }`}
                >
                  Contact Us
                </button>
                ...
                <button
                  className={`rounded-xl p-2 px-3 transition-all duration-300 ${
                    isScrolled
                      ...
                      : "border border-primary text-white  hover:bg-primary/80 bg-primary"
                  }`}
                >
                  Contact Us
                </button>
